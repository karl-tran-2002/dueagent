...
const UI = {
  ...
  _showWelcome() {
    ...
    messagesEl.innerHTML = `
      <div class="welcome-container">
        <div class="welcome-avatar"><img src="assets/chatbot_logo.png" alt="AI Chatbot K17" style="width:50px;height:50px;object-fit:contain;"></div>
  ...
  appendMessage(role, content) {
    ...
    const avatar = role === 'user' ? `<img src="assets/people.png" alt="Bạn" style="width:100%;height:100%;object-fit:contain;">` : `<img src="assets/robot2.png" alt="AI Chatbot K17" style="width:100%;height:100%;object-fit:contain;">`;
  ...
  showTypingIndicator() {
    ...
    indicator.innerHTML = `
      <div class="message-avatar"><img src="assets/robot2.png" alt="AI Chatbot K17" style="width:100%;height:100%;object-fit:contain;"></div>
